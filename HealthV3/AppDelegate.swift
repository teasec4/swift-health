...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(
        ...
        scheduleAppRefresh()
        print(
            "AppDelegate: Initialized with notification permission request and background task setup"
        )
        return true
    }
    ...
    func scheduleAppRefresh() {
        let request = BGAppRefreshTaskRequest(
            identifier: "com.yourapp.resetData"
        )
        ...
        do {
            ...
            print(
                "AppDelegate: Scheduled background task for \(String(describing: request.earliestBeginDate))"
            )
        } catch {
